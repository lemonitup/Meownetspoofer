...
# Fixed ASCII art using raw string to avoid invalid escape sequence warnings
print(r"""
  /\_/\  
 ( o.o ) 
  > ^ <  
...
# initialize all IP-related variables with default empty strings
old_IP_address = ""
changed_IP_address = ""
old_ip_netmask = ""
changed_IP_netmask = ""
...
# to ask user if they want the previous ip/mac address to be outputted so they can remember
...
# call the changing network function
